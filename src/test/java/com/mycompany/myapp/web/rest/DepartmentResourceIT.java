...
public class DepartmentResourceIT {
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getOrganizationUnitID()).isEqualTo(DEFAULT_ORGANIZATION_UNIT_ID);
    ...
    public void updateDepartment() throws Exception {
        ...
        Department testDepartment = departmentList.get(departmentList.size() - 1);
        assertThat(testDepartment.getOrganizationUnitID()).isEqualTo(UPDATED_ORGANIZATION_UNIT_ID);
