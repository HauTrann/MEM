...
//            "Hợp đồng",
    ...
    interface MBCreditCard {
        ...
        List<String> HEADER = Arrays.asList("Ngày chứng từ", "Ngày hạch toán", "Số chứng từ", "Loại chứng từ", "Số thẻ", "Đơn vị nhận", "Diễn giải", "Tổng tiền thanh toán");
    ...
    interface SAInvoice1 {
        String NAME = "Bán hàng chưa thanh toán";
        List<String> HEADER = Arrays.asList("Ngày chứng từ", "Ngày hạch toán", "Số chứng từ", "Số hóa đơn",
            "Đối tượng", "Diễn giải", "Tổng tiền hàng", "Tổng CK", "Tổng thuế GTGT", "Tổng tiền TT");
        List<String> FIELD = Arrays.asList("date", "postedDate", "noBook", "invoiceNo", "accountingObjectName",
            "reason", "totalAmount", "totalDiscountAmount", "totalVATAmount", "totalAllAmount");
    }

    interface SAInvoice2 {
        String NAME = "Bán hàng thanh toán ngay";
        List<String> HEADER = Arrays.asList("Ngày chứng từ", "Ngày hạch toán", "Số chứng từ", "Số hóa đơn",
            "Đối tượng", "Diễn giải", "Tổng tiền hàng", "Tổng CK", "Tổng thuế GTGT", "Tổng tiền TT");
        List<String> FIELD = Arrays.asList("date", "postedDate", "noBook", "invoiceNo", "accountingObjectName",
             "reason", "totalAmount", "totalDiscountAmount", "totalVATAmount", "totalAllAmount");
