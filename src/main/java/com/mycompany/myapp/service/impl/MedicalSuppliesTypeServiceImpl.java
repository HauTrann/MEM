...
public class MedicalSuppliesTypeServiceImpl implements MedicalSuppliesTypeService {
    ...
    public MedicalSuppliesType save(MedicalSuppliesType medicalSuppliesType) {
        ...
        if (medicalSuppliesType.getOrganizationUnitID() == null) {
            medicalSuppliesType.setOrganizationUnitID(SecurityUtils.getCurrentUserLoginAndOrg().get().getOrg());
        }
    ...
    @Override
    public Page<MedicalSuppliesType> findAllByOrganizationUnitID(Pageable pageable) {
        log.debug("Request to get all MedicalSuppliesTypes");
        return medicalSuppliesTypeRepository.findAllByOrganizationUnitID(pageable, SecurityUtils.getCurrentUserLoginAndOrg().get().getOrg());
    }
